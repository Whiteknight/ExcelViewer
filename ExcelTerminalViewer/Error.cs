...
public sealed record UnknownException(Exception Exception) : Error($"Unknown exception: {Exception.GetType().Name} {Exception.Message}", Exception.StackTrace ?? string.Empty);
